...
fn wait_closed_drains_current_thread_tsd_dtor() {
    const NAME: &str = "vm::engine::deferred::tests::wait_closed_drains_current_thread_tsd_dtor";
...
fn deleted_tsd_destructor_thunk_is_a_stable_noop() {
    const NAME: &str = "vm::engine::deferred::tests::deleted_tsd_destructor_thunk_is_a_stable_noop";
