...
fn physically_masked_inbox_event_does_not_deadlock_engine_close() {
    ...
    let test_name = "vm::engine::embed_tests::signal_close::physically_masked_inbox_event_does_not_deadlock_engine_close";
...
fn close_drain_does_not_lose_a_handler_reraise_on_its_temporary_thread() {
    ...
    let test_name = "vm::engine::embed_tests::signal_close::close_drain_does_not_lose_a_handler_reraise_on_its_temporary_thread";
    let mut child = std::process::Command::new(std::env::current_exe().unwrap())
        .args(["--exact", test_name, "--nocapture"])
        .env(CHILD, "1")
        .stdout(std::process::Stdio::piped())
...
fn close_drain_exhausts_cross_engine_synchronous_raises_before_sealing() {
    ...
    let test_name = "vm::engine::embed_tests::signal_close::close_drain_exhausts_cross_engine_synchronous_raises_before_sealing";
    let mut child = std::process::Command::new(std::env::current_exe().unwrap())
        .args(["--exact", test_name, "--nocapture"])
        .env(CHILD, "1")
        .stdout(std::process::Stdio::piped())
...
fn wait_closed_fails_fast_for_a_finalizer_deferred_by_the_current_signal_mask() {
    ...
    let test_name = "vm::engine::embed_tests::signal_close::wait_closed_fails_fast_for_a_finalizer_deferred_by_the_current_signal_mask";
    let mut child = std::process::Command::new(std::env::current_exe().unwrap())
        .args(["--exact", test_name, "--nocapture"])
        .env(CHILD, "1")
        .stdout(std::process::Stdio::piped())
...
fn masked_cross_engine_close_hands_finalization_to_an_unmasked_thread() {
    ...
    let test_name = "vm::engine::embed_tests::signal_close::masked_cross_engine_close_hands_finalization_to_an_unmasked_thread";
    let mut child = std::process::Command::new(std::env::current_exe().unwrap())
        .args(["--exact", test_name, "--nocapture"])
        .env(CHILD, "1")
        .stdout(std::process::Stdio::piped())
