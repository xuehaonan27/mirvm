...
pub(crate) fn simd_bin_body(
    ...
    use crate::vm::ir::{LaneKind, SimdBinOp as S};
...
pub(crate) fn simd_un_body(
    ...
    use crate::vm::ir::{BitUnOp, LaneKind, SimdUnOp as U};
...
pub(crate) fn simd_reduce_arith_body(
    ...
    use crate::vm::ir::{LaneKind, SimdReduceOp as R};
    let pa = pa as u64;
    let lb = lb as u64;
    let lw = Width::from_bytes(lb).expect("lane width");
