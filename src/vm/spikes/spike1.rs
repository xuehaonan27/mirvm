...
fn build_fib() -> Program {
    ...
    Program { funcs: vec![Body { num_slots: 7, num_args: 1, blocks }] }
}
...
fn build_loop_sum() -> Program {
    ...
    let blocks = vec![
        ...
        Block {
            ...
            term: SwitchInt { discr: s(3), targets: vec![(0, 3)], otherwise: 2 },
        },
    ...
    Program { funcs: vec![Body { num_slots: 4, num_args: 1, blocks }] }
}
...
fn build_mem_sum() -> Program {
    ...
    let blocks = vec![
        ...
        Block {
            stmts: vec![asgn(4, bin(Lt, s(3), s(1)))],
            term: SwitchInt { discr: s(4), targets: vec![(0, 6)], otherwise: 5 },
        },
