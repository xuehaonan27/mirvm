...
1. **产品能力顺序**（2026-08-08 汇总）：`mirvm test` 的当前单包/workspace 合同已完成；
   下一步是依赖 P5（Git → alt registry/config → source replacement/patch → pack self）→ OS 级沙箱与
