# tsan/ — the execution phase under ThreadSanitizer
...
does not cover it. `rustfmt --edition 2024 tsan/src/cases/*.rs tsan/src/product_adapters.rs`
works; `tsan/src/main.rs` and `tsan/src/telemetry.rs` must be checked with
