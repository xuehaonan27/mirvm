...
//   A: target/release/mirvm run tests/data/programs/c_wasmtime_wat.rs
...
//   C: MIRVM_JIT_THRESHOLD=1 target/release/mirvm run tests/data/programs/c_wasmtime_wat.rs
