...
//   empty.
// Three-way rerun:
//   A: target/release/mirvm run tests/data/programs/c_chumsky_parse.rs
//   B: cd "$(grep -l 'name = "c_chumsky_parse"' ~/.cache/mirvm/scripts/*/Cargo.toml | xargs dirname)" && \
//        RUSTC="$HOME/.rustup/toolchains/nightly-2026-07-02-x86_64-unknown-linux-gnu/bin/rustc" \
//        "$HOME/.rustup/toolchains/nightly-2026-07-02-x86_64-unknown-linux-gnu/bin/cargo" run -q
//   C: MIRVM_JIT_THRESHOLD=1 target/release/mirvm run tests/data/programs/c_chumsky_parse.rs
