...
//   A: target/release/mirvm run tests/data/programs/c_mimalloc.rs
//   B: cd $(grep -l 'name = "c_mimalloc"' ~/.cache/mirvm/scripts/*/Cargo.toml \
//        | head -1 | xargs dirname) && \
//      RUSTC="$HOME/.rustup/toolchains/nightly-2026-07-02-x86_64-unknown-linux-gnu/bin/rustc" \
//      "$HOME/.rustup/toolchains/nightly-2026-07-02-x86_64-unknown-linux-gnu/bin/cargo" run -q
//   C: MIRVM_JIT_THRESHOLD=1 target/release/mirvm run tests/data/programs/c_mimalloc.rs
//
...
//   A: CFLAGS="-DMI_PRIM_HAS_PROCESS_ATTACH" target/release/mirvm run tests/data/programs/c_mimalloc.rs
//   B: cd $(grep -l 'name = "c_mimalloc"' ~/.cache/mirvm/scripts/*/Cargo.toml \
//        | head -1 | xargs dirname) && \
...
//      target/release/mirvm run tests/data/programs/c_mimalloc.rs
//
