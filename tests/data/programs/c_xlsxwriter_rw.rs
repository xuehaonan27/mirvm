...
//
// Three-way rerun:
//   A: target/release/mirvm run tests/data/programs/c_xlsxwriter_rw.rs
...
//   C: MIRVM_JIT_THRESHOLD=1 target/release/mirvm run tests/data/programs/c_xlsxwriter_rw.rs
//
