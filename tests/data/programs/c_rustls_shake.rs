...
//   A: target/release/mirvm run tests/data/programs/c_rustls_shake.rs
...
//   C: MIRVM_JIT_THRESHOLD=1 target/release/mirvm run tests/data/programs/c_rustls_shake.rs
