...
FIXTURE=$REPO_ROOT/tests/suites/contracts/fixtures/cargoless/workspace-contract
REMAINING=$REPO_ROOT/tests/suites/contracts/fixtures/cargoless/workspace-legacy-contract
