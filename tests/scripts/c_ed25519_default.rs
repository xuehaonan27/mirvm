...
//   A: target/release/mirvm run tests/scripts/c_ed25519_default.rs
//   B: cd $(dirname $(grep -l 'name = "c_ed25519_default"' ~/.cache/mirvm/scripts/*/Cargo.toml)) && \
//      RUSTC="$HOME/.rustup/toolchains/nightly-2026-07-02-x86_64-unknown-linux-gnu/bin/rustc" \
//      "$HOME/.rustup/toolchains/nightly-2026-07-02-x86_64-unknown-linux-gnu/bin/cargo" run -q
//   C: MIRVM_JIT_THRESHOLD=1 target/release/mirvm run tests/scripts/c_ed25519_default.rs
//   ④ backend comparison (manual): CARGO_CFG_CURVE25519_DALEK_BACKEND=serial \
//      target/release/mirvm run tests/scripts/c_ed25519_default.rs -- stdout must match A byte-for-byte.
