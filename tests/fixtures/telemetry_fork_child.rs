...
// instrumented syscalls, forks through the libc wrapper, and the child records
// two of its own before exiting normally. Correct behaviour:
//
//   events-<parent pid>-0.mlog   parent records, generation 0
...
// missing and the child's event stream was silently empty.
//
