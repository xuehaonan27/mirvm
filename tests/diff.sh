...
# 全绿基线 28/28（M4.4 起含 threads_*；M5.0 起含 asm_probe；真实项目 TDD
# 新增 track_caller_fn_ptr/u128_switch/volatile_wide；M5.2 起含 intrinsic_probe/
# recursion_deep/simd_probe/atomic_order_probe/float_wide_probe/asm_extras_probe/signal_probe/fork_exec_probe）。
